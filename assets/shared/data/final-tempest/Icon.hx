...
var spookyIcon666 = new HealthIcon('spooky-evil', true);
spookyIcon666.y = game.healthBar.y - 60;
spookyIcon666.cameras = [game.camHUD];
game.add(spookyIcon666);
spookyIcon666.alpha = 0;
...
function onStepHit() {
spookyIcon666.scale.set(1.1, 1.1);
spookyIcon666.updateHitbox();

spookyIcon.scale.set(1.1, 1.1);
spookyIcon.updateHitbox();

spookyIcon2.scale.set(1.1, 1.1);
spookyIcon2.updateHitbox();

spookyIcon3.scale.set(1.1, 1.1);
spookyIcon3.updateHitbox();

spookyIcon4.scale.set(1.1, 1.1);
spookyIcon4.updateHitbox();

spookyIcon5.scale.set(1.1, 1.1);
spookyIcon5.updateHitbox();

spookyIcon6.scale.set(1.1, 1.1);
spookyIcon6.updateHitbox();

momIcon.scale.set(1, 1);
momIcon.updateHitbox();
if (curStep == 1280)
{
spookyIcon666.alpha = 1;
}
if (curStep == 1632) {
game.remove(spookyIcon666);
spookyIcon.alpha = 1;
}
if (curStep == 1792)
{
...
function onUpdate(elapsed:Float) {
	...
	spookyIcon666.x = game.healthBar.barCenter + (150 * spookyIcon666.scale.x - 150) / 2 - iconOffset + 0;
	spookyIcon666.animation.curAnim.curFrame = (game.healthBar.percent < 20) ? 1 : 0;
...
{
	spookyIcon666.scale.set(game.iconP1.scale.x - 0.1, game.iconP1.scale.y - 0.1);
	spookyIcon666.updateHitbox();
	spookyIcon.scale.set(game.iconP1.scale.x - 0.1, game.iconP1.scale.y - 0.1);
	spookyIcon.updateHitbox();
	spookyIcon2.scale.set(game.iconP1.scale.x - 0.1, game.iconP1.scale.y - 0.1);
	spookyIcon2.updateHitbox();
	spookyIcon3.scale.set(game.iconP1.scale.x - 0.1, game.iconP1.scale.y - 0.1);
	spookyIcon3.updateHitbox();
	spookyIcon4.scale.set(game.iconP1.scale.x - 0.1, game.iconP1.scale.y - 0.1);
	spookyIcon4.updateHitbox();
	spookyIcon5.scale.set(game.iconP1.scale.x - 0.1, game.iconP1.scale.y - 0.1);
	spookyIcon5.updateHitbox();
    spookyIcon6.scale.set(game.iconP1.scale.x - 0.1, game.iconP1.scale.y - 0.1);
	spookyIcon6.updateHitbox();
