...
var GF2 = new Character(-50, 160, 'gf-tempest-dark', false);
...
function onBeatHit(){
	...
	if (curBeat == 127) {
		game.remove(GF2);
		GF2 = new Character(-50, 160, 'gf-tempest', false);
		game.startCharacterPos(GF2, false);
		game.add(GF2);
	...
	if (curBeat == 576) {
		game.remove(GF2);
		GF2 = new Character(-50, 230, 'gf-tempest-mom', false);
		game.startCharacterPos(GF2, false);
		game.add(GF2);
    ...
    if (curBeat == 800) {
		game.remove(GF2);
		GF2 = new Character(-50, 160, 'gf-tempest2', false);
		game.startCharacterPos(GF2, false);
		game.add(GF2);
...
function onStepHit() {
	...
	if (curStep == 3072) {
		game.remove(GF2);
		GF2 = new Character(-50, 230, 'gf-tempest-mom2', false);
		game.startCharacterPos(GF2, false);
		game.add(GF2);
