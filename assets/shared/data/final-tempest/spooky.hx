...
var spooky = new Character(1160, 80, 'spooky-dad', true);
...
function onBeatHit(){
	...
	if (curBeat == 448) {
		game.remove(spooky);
		spooky = new Character(1320, 150, 'spooky-dad2', true);
	...
	if (curBeat == 512) {
		game.remove(spooky);
		spooky = new Character(1320, 150, 'spooky-dad', true);
		game.startCharacterPos(spooky, false);
		game.add(spooky);
    ...
    if (curBeat == 924) {
		game.remove(spooky);
		spooky = new Character(1320, 180, 'spooky-dad4', true);
		game.startCharacterPos(spooky, false);
		game.add(spooky);
    ...
    if (curBeat == 992) {
		game.remove(spooky);
		spooky = new Character(1230, 180, 'spooky-dad5', true);
		game.startCharacterPos(spooky, false);
		game.add(spooky);
...
function onStepHit() {
	...
	if (curStep == 3584) {
	spooky = new Character(1320, 150, 'spooky-dad3', true);
	game.startCharacterPos(spooky, false);
	game.add(spooky);
	spooky.alpha = 1;
	chars = [
